    ...
    <div class="row  vh">
        <div class="col-4 mx-auto mt-5 ">
            <form action="{{ route('store_user') }}" method="POST" enctype="multipart/form-data">
                ...
                @method('POST')
                <div class="col-12">
                    <h5 class="text-center">Registar conta</h5>
                </div>
                <div class="row row-cols-1 gy-2">
                    ...
                    <div class="col">
                        <div class="form-floating">
                            <input id="password" type="password" name="password" class="form-control form-control-sm rounded-0 " placeholder="">
                    ...
                    <div class="col">
                        <div class="form-floating">
                            <input id="" type="password" name="Numero" class="form-control form-control-sm rounded-0 " placeholder="Numero">
                            <label for="" class="form-label">confirmar password</label>
                        </div>
                    </div>

                    <div class="col">
                        <a href="{{ route('login') }}">Ja tenho conta de usuario.</a>
                    </div>
